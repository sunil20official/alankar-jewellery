		...
		<div>
			<div className='contact-section-container'>
				<HeadComponent
					...
					marginTop={'-4rem'}
				/>
				<div className='container contacts-section' style={{ background: 'black' }}>
					<div className='row' style={{ maxWidth: '1080px', margin: '0 auto' }}>
						<div className='col-md-4 col-sm-6 mt-5'>
							<div className='card vh-50' style={{ border: '3px solid #fbbc93' }}>
								...
								<div className='flagship-store-section'>
									...
									<br />
									West Boring Canal Rd <br /> Sri Krishna Nagar, Buddha Colony <br />{' '}
