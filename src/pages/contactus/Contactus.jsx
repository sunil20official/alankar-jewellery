          ...
          <div style={{maxWidth:"1080px",margin:"0 auto"}} className="row">
            <div className="col-md-4 col-sm-6 mt-5">
              <div className="card vh-50 border">
                <h5 style={{fontFamily:"RegularCaslon"}}>ALANKAR JEWELLERS</h5>
                <div className="flagship-store-section">
                  ...
                  <br />
                  Alankar Business Center <br /> East Boring Canal Road <br />{" "}
                  Patna, Bihar, India 800001 <br /> Tel :&nbsp;
                  <a href="tel:+91 xx xx xxxxx">
                    +91 XX XXXX XXXX{" "}
                  </a> <br /> Tel :&nbsp;
                  <a href="tel:+91612 2559154">+91 61 2255 9154</a>
                  <br /> Mob :&nbsp;{" "}
                  <a href="tel:+XXXXXXXXXX">+91 9065521594</a> <br /> Email
                  :&nbsp;{" "}
                ...
                <div className="flagship-store-section">
                  ...
                  <br /> Mob :&nbsp;{" "}
                  <a href="tel:+XXXXXXXXXX">+91 XXXXXXXXXX</a> <br /> Email
                  :&nbsp;{" "}
                  <a href="mailto:info.agj@alankarjewellers.com">
                    info.agj@alankarjewellers.com
                  </a>
