          ...
          <div className="row">
            <div className="col-md-3 col-sm-6 mb-3">
              ...
              <p className="footer-text">
                Welcome to Alankar Jewellers, where luxury and elegance meet to
                create timeless pieces of jewellery that will last a lifetime.
                We are proud to present our exquisite collections, featuring
                beautifully crafted diamond, polki, and gold jewellery, as well
                as stunning engagement and bridal sets
              </p>
            </div>
            ...
            <div className="col-md-3 col-sm-6 mb-3">
              ...
              <div className="footer-reach-us">
                <p>
                  ...
                  <br /> Alankar Business Center <br /> East Boring Center{" "}
                  <br />
